...
В целях упрощения сравнивать экземпляры класса Vector будем только по их длине, используя метод len,
...
class Vector:
    ...
    def __eq__(self, vector):
        return self.len() == (vector.coordinates.x**2 + vector.coordinates.y**2)**0.5
